            ...
            <div>
                <div className="container">
                    <div className="d-flex flex-row-reverse">
                        <Link to="offers/create" className="btn btn-primary  mt-1">+ إضافة عرض</Link>
                    </div>
                    ...
                    <div className="row mb-3 align-items-stretch">
                        <div className="col-lg-3 mb-3">
                            <Link to="/offers/1">
                                <div className="card border-0 h-100" >
                                    <img className="card-img-top" src="img/examples/offer-1.png" alt="مكتبة جرير" />
                        ...
                        <div className="col-lg-3 mb-3">
                            <Link to="/offers/1">
                                <div className="card border-0 h-100" >
                                    <img className="card-img-top" src="img/examples/offer-2.png" alt="المسافر" />
                                    <div className="card-body bg-light d-flex justify-content-between align-items-center">
                        ...
                        <div className="col-lg-3 mb-3">
                            <Link to="/offers/1">
                                <div className="card border-0 h-100" >
                                    <img className="card-img-top" src="img/examples/offer-3.png" alt="كبريتو" />
                                    <div className="card-body bg-light d-flex justify-content-between align-items-center">
                        ...
                        <div className="col-lg-3 mb-3">
                            <Link to="/offers/1">
                                <div className="card border-0 h-100" >
                                    <img className="card-img-top" src="img/examples/offer-4.png" alt="كور" />
                                    <div className="card-body bg-light d-flex justify-content-between align-items-center">
